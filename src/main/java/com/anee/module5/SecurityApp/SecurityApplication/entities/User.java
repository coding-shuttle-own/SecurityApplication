...
import com.anee.module5.SecurityApp.SecurityApplication.utils.PermisssionMapping;
...
public class User implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        ...
        roles.forEach(
                role -> {
                    Set<SimpleGrantedAuthority> permissions = PermisssionMapping.getAuthoritiesForRole(role);
